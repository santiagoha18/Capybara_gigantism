      seqfile = align.phy * sequence data filename
     treefile = tree.tre      * tree structure file name
      outfile = MDeriva.out           * main result file name
   ...
   aaRatefile = grantham.dat  * only used for aa seqs with model=empirical(_F)
